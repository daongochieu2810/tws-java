...
import twsjava.lib.client.Types.ExerciseType;
import twsjava.lib.client.Types.FADataType;
import twsjava.lib.client.Types.FundamentalType;
import twsjava.lib.client.Types.NewsType;
import twsjava.lib.client.Types.WhatToShow;
import twsjava.lib.controller.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	@Override public void historicalData(int reqId, twsjava.lib.client.Bar bar) {
    ...
    @Override
    public void historicalDataUpdate(int reqId, twsjava.lib.client.Bar bar) {
